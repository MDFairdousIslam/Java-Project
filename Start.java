...
public class Start
{
	public static void main(String args[])
	{
		...
		String fn, bn;
		System.out.print("Enter Ticket Shop Name: ");
		fn = sc.next();
		System.out.print("Enter Ticket Shop Branch: ");
		bn = sc.next();
		...
		while(repeat)
		{
			...
			System.out.println("\t\t5. Show Ticket Shop Information");
			...
			switch(choice)
			{
							...
							case 1:
								...
								if(c1 != null)
								{
									...
									if(type == 1)
									{
										...
										MovieTicket sa = new MovieTicket(an, c1, ba, ir);
									...
									else if(type == 2)
									{
										...
										BusTicket fa = new BusTicket(an, c1, ba, ty);
				...
				case 5:
					...
					System.out.println("##################################");
					System.out.println("You Have Selected Ticket Shop Information");
					System.out.println("##################################");
					System.out.println();
